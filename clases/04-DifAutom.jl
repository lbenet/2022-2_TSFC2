...
# En la [clase anterior](./03-DerivadasNumericas.jl), vimos diferentes formas de implementar
...
# puntos cercanos.
# Ahí obtuvimos que el error absoluto en términos de $h$ (cuando
...
# adecuadas que permiten obtener los resultados que bscamos.
...
# al número imaginario $\mathrm{i}$; este punto será clave más adelante con extendamos este
...
# Un punto importante a recalcar es,
# si el dual es de la forma $u = {\mathbb{D}_{x_0} x}$, es decir, corresponde a la
...
# garantizan que la composición de funciones se puede usar con duales.
